...
import static org.pragyaa.pragyaa2017.R.id.rule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEventDatabase.child(eventCategory).child(String.valueOf(position)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                eventName = (String) dataSnapshot.child("event_name").getValue();
                rules = (String) dataSnapshot.child("rules").getValue();
                desc = (String) dataSnapshot.child("desc").getValue();
                play = (String) dataSnapshot.child("play").getValue();
                specs = (String) dataSnapshot.child("specs").getValue();
                coordinatorOne = (String) dataSnapshot.child("coordi_one").getValue();
                mobileone = (String) dataSnapshot.child("mobile_one").getValue();
                coordinatorTwo = (String) dataSnapshot.child("coordi_two").getValue();
                mobiletwo = (String) dataSnapshot.child("mobile_two").getValue();
                imgUrl = (String) dataSnapshot.child("link").getValue();
